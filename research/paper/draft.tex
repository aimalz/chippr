...
In \Sect{sec:diag}, we present the quantitative metrics by which 
...
%	\aim{TODO: Circulate draft to GCCL; submit to ApJ; circulate to Dan Foreman-Mackey, Boris Leistedt, Kate Storey-Fisher; post to arXiv; circulate to Alan Heavens, Ann Lee, Phil Marshall, Anze Slosar, others for feedback.}
