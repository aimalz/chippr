...
However, any procedure that reduces \pzpdf s to point estimates discards valuable information about the uncertainty on redshift.
...
They have been used to form selection criteria of samples from galaxy surveys without propagation through the calculations of physical parameters \citep{van_breukelen_reliable_2009, viironen_high_2015}.  
...
The redshift distribution is a key input to the traditional calculation of the power spectra of weak gravitational lensing and large-scale structure that are used to constrain the parameters of cosmological models \citep{mandelbaum_precision_2008, hildebrandt_cfhtlens:_2012, sheldon_photometric_2012, benjamin_cfhtlens_2013, kelly_weighing_2014, bonnett_using_2015,  masters_mapping_2015, viironen_high_2015, asorey_galaxy_2016, bonnett_redshift_2016, yang_calibrating_2018}, as well as to validate survey selection functions used in generation of realistic, multi-purpose mock catalogs \citep{norberg_2df_2002}.
Even with \pz s adhering to the \lsst\ requirements of \Tab{tab:lsstsrd}, the accuracy and precision to which \nz\ must be known limit the degree to which constraints on the cosmological parameters can advance \citep{abruzzo_impact_2019}.
...
\begin{figure*}
	\begin{center}
		...
		\caption{
			...
			\aim{How to make this more attractive?}
			}
		\label{fig:flowchart}
	\end{center}
\end{figure*}
...
\dwh{So a Fisher matrix analysis inherently can't provide the bias.
